...
export default function About() {
	return (
        ...
        About the author
			...
			<p>
        I am a chaotic evil multiclass <a href='https://simone-poggi.com' target='_blank' rel='noreferrer'>developer</a>/<a href='https://motocarota.art' target='_blank' rel='noreferrer'>artist</a>.
			</p>
		</>
	);
}
